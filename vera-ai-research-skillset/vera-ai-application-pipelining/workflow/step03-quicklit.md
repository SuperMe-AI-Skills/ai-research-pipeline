...
```
Read and execute reference/patterns/literature-reviewing.md with context: "{research_question} {modality} deep learning methods {discipline}"
```
...
the detected modality from `reference/specs/method-tracks.md` with no
...
## Source: reference/specs/method-tracks.md -- [modality] section
...
`{REPO_ROOT}/{analyzing_skill_path}`) at
...
**Use the canonical track IDs from `reference/specs/method-tracks.md` verbatim**.
