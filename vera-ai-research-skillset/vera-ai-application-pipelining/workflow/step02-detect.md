...
Read `reference/rules/modality-detection-rules.md` for the full decision tree.
...
Look up the confirmed modality in `reference/specs/skill-routing-table.md`.
...
```json
{
  ...
  "testing_skill_path": "vera-ai-nlp-reviewing",
  "analyzing_skill_path": "vera-ai-nlp-generating",
  "timestamp": "..."
}
```
...
- `{analyzing_skill_path}/` -> workflow steps 04-08 + scripts/python/

Per-modality routing (from `reference/specs/skill-routing-table.md`):
