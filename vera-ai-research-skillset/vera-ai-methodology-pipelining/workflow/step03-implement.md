...
Read `reference/specs/experiment-standards.md` for training and evaluation requirements.
Read `reference/patterns/benchmark-patterns.md` for benchmark protocol patterns.
