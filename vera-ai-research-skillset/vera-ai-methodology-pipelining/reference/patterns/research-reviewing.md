...
If `IDEA_REVIEW_MODE = "external"`, submit to the configured reviewer bridge:
...
external_reviewer_bridge:
  ...
  prompt: |
    You are a senior ML researcher with top-tier publication experience.
...
whether an external reviewer bridge is installed.
